...
//2. Crear los atributos de la clase
    ...
    public void recibeDatos(int idEmpl, String nombreEmp, String apellidos, String document, String correo) {
        System.out.println(idEmpl + " " + nombreEmp + " " + document + " " + correo);
        txtId.setText("" + idEmpl);
    ...
    public void actualizarEmpleado() {
        ...
        if (nombre.isEmpty()) {
            ...
            try{
                ...
                JOptionPane.showMessageDialog(this, "Se han actualizado los datos del empelado.", "",JOptionPane.INFORMATION_MESSAGE);
